...
{
    public class AssetBundleDepVisWindow : EditorWindow
    {
        [MenuItem("Custom/Node editor")]   
        public static void OpenForEditor()
        {
            AssetBundleDepVisWindow window = EditorWindow.GetWindow<AssetBundleDepVisWindow>();
        ...
        protected void InitForEditor()
        {
            ...
            this.Lines.Add(new EditorLine(this.Windows[0], this.Windows[1], Color.blue));
            // TODO test lines
        }
